    ...
    <div className="space-y-4">
      ...
      <div className="border border-border rounded-lg p-6 bg-background print:border-none print:rounded-none print:p-0 print:text-black" id="requisition-form">
        ...
        <div className="relative mb-1 print:mb-0">
          <p className="text-sm text-muted-foreground print:text-black text-right receipt-no"><p className="text-sm text-muted-foreground print:text-black text-right receipt-no">เลขที่เบิก<span className="hidden print:inline dotted-underline">{withdrawNo || '.............................'}</span><span className="print:hidden">.....................</span></p> || '.............................'}</span><span className="print:hidden">.....................</span></p>
          ...
          <p className="text-sm text-muted-foreground print:text-black text-right form-info"><p className="text-sm text-muted-foreground print:text-black text-right form-info"><p className="text-sm text-muted-foreground print:text-black text-right form-info">วันที่<span className="hidden print:inline dotted-underline">{date ? format(date, "d") : '......'}</span><span className="print:hidden">......</span>/<span className="hidden print:inline dotted-underline">{date ? format(date, "MMMM", { locale: th }) : '............'}</span><span className="print:hidden">............</span>/<span className="hidden print:inline dotted-underline">{date ? (date.getFullYear() + 543).toString() : '............'}</span><span className="print:hidden">............</span></p> : '......'}</span><span className="print:hidden">......</span>/<span className="hidden print:inline print:mx-1">{date ? format(date, "MMMM", { locale: th }) : '............'}</span><span className="print:hidden">............</span>/<span className="hidden print:inline print:mx-1">{date ? (date.getFullYear() + 543).toString() : '............'}</span><span className="print:hidden">............</span></p><span className="print:hidden">......</span>/<span className="hidden print:inline print:mx-1">{date ? `...${format(date, "MMMM", { locale: th })}...` : '............'}</span><span className="print:hidden">............</span>/<span className="hidden print:inline print:mx-1">{date ? `...${(date.getFullYear() + 543).toString()}...` : '............'}</span><span className="print:hidden">............</span></p>
        </div>
